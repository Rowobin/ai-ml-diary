...
In order to test the effects of data and batch normalization, I created 3 versions of the same model and trained it on the [wine-quality dataset](https://archive.ics.uci.edu/dataset/186/wine+quality).
