...
**L1/L2 regularization cost function:**
$$
𝓙 = \frac{1}{n} \sum_{i=1}^n{𝓛(y_{prediction_i}, y_{expected_i}) + λ * penalty(w)}
$$
...
**L2 Regularization**
$$
penalty_{L2} = ||w||^{2}_{2} = \sum_{i}{w^{2}_{i}}
$$
